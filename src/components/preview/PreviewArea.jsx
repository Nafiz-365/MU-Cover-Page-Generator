...
export default function PreviewArea() {
    ...
    const autoFitScale = Math.min(
        1.0,
        Number((availableW / A4_WIDTH).toFixed(3)),
    );
    ...
    const handleZoomIn = () =>
        setUserZoom((prev) => Math.min(prev + 0.15, 2.0));
    const handleZoomOut = () =>
        setUserZoom((prev) => Math.max(prev - 0.15, 0.5));
        ...
        >
            ...
            >
                ...
                <div className="flex items-center gap-1">
                    ...
                    <button
                        type="button"
                        onClick={() =>
                            setUserZoom(Number((1 / autoFitScale).toFixed(2)))
                        }
            ...
            <div className="lg:hidden fixed bottom-20 right-4 z-30 flex flex-col items-end gap-2.5">
                ...
                <button
                    ...
                    aria-label={
                        fabOpen ? 'Close download menu' : 'Open download menu'
                    }
