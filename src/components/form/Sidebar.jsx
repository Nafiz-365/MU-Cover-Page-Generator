...
export default function Sidebar({ sidebarPercent = 40, isDragging }) {
    ...
    const handleFormKeyDown = (event) => {
        ...
        if (
            !current.matches('input, select, textarea') ||
            current.type === 'file'
        ) {
            return;
        }
        ...
        const nextField = fields[fields.indexOf(current) + 1];
    ...
    return (
        ...
        >
            ...
            >
                    ...
                    <div className="flex items-center justify-between gap-3 mb-3">
                        <div className="flex items-center gap-2.5 min-w-0">
                            ...
                            <div className="min-w-0">
                                ...
                                <p
                                    className="text-[11px] sm:text-xs leading-snug mt-0.5"
                                    style={{ color: 'var(--subtext)' }}
                                >
                                    {isLab
                                        ? 'Customize experiment and lab submission'
                                        : 'Fill details for university assignment'}
                                </p>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-1 mb-2.5">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    updateField('workTitle', e.target.value)
                                }
                                onBlur={() => handleSmartBlur('workTitle')}
                                placeholder={
                                    isLab
                                        ? 'e.g. Implementation of Bresenham Algorithm'
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        updateField('workNo', e.target.value)
                                    }
                                    placeholder="e.g. 01"
                                    className={inputClasses}
                                    style={inputStyle}
                ...
                <div
                    className="sticky bottom-0 z-20 flex flex-row gap-2.5 mt-5 pt-3.5 pb-1 backdrop-blur-xl border-t border-(--card-border)"
                    style={{
                        backgroundColor: 'var(--card-bg)',
                    }}
                >
                    ...
                    <button
                        ...
                        className="flex-1 min-w-0 py-3 px-2 rounded-xl font-bold text-xs uppercase tracking-wider text-white bg-blue-600 hover:bg-blue-500 active:scale-[0.98] transition-all flex items-center justify-center gap-1.5 shadow-md shadow-blue-600/30 disabled:opacity-50 cursor-pointer"
                    >
                        {generatingPdf ? (
                            <>
                    ...
                    <button
                        ...
                        disabled={generatingPdf || savingImage}
                        className="flex-1 min-w-0 py-2.5 px-2 rounded-xl font-semibold text-xs transition-all flex items-center justify-center gap-1.5 disabled:opacity-50 cursor-pointer border border-slate-200/80 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/5 active:scale-[0.98]"
                        style={{
                            backgroundColor: 'var(--btn-secondary-bg)',
